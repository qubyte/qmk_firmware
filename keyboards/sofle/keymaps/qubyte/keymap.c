 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE | RCTR |  UP  | DOWN |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX ,KC_N,     KC_M,     KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
                 KC_LGUI,KC_LALT,KC_LCTRL, KC_LOWER, KC_SPC,      KC_SPC,  KC_RAISE, KC_RCTRL, KC_UP,   KC_DOWN
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_LEFT, KC_DOWN, KC_RIGHT,  _______, _______,                         _______, KC_MINS,  KC_EQL, _______, _______, _______,
  _______, _______,  KC_CUT, KC_COPY,  KC_PASTE, KC_UNDO, _______,       _______, _______, _______, _______, _______, _______, _______,
 ...
 */
  ...
  _______, RESET,   KC_QWERTY, KC_COLEMAK, _______, _______,                        _______, _______, _______, _______, _______, _______,
